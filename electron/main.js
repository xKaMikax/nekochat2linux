...
async function prepareTheme(id) {
  ...
  if (theme.classic) {
    ...
    await fs.writeFile(path.join(directory, 'theme.css'), ':root{--xp-caption-left:1px;--xp-caption-right:1px;--xp-caption-middle:1px;--xp-caption-height:23px;--xp-bottom-left:1px;--xp-bottom-right:1px;--xp-bottom-middle:1px;--xp-bottom-height:3px;--xp-theme-window:#fff;--xp-theme-buttonface:#d4d0c8;--xp-theme-windowtext:#000;--xp-theme-highlight:#000080;--xp-title-fill:linear-gradient(#000080,#000080);--xp-caption-normal:linear-gradient(#fff,#c0c0c0);--xp-caption-hover:linear-gradient(#fff,#c0c0c0);--xp-caption-pressed:linear-gradient(#c0c0c0,#fff);--xp-close-normal:linear-gradient(#fff,#c0c0c0);--xp-close-hover:linear-gradient(#fff,#c0c0c0);--xp-close-pressed:linear-gradient(#c0c0c0,#fff);--xp-close-glyph:none;--xp-close-glyph-hover:none;--xp-close-glyph-pressed:none;--xp-minimize-glyph:none;--xp-minimize-glyph-hover:none;--xp-minimize-glyph-pressed:none;--xp-maximize-glyph:none;--xp-maximize-glyph-hover:none;--xp-maximize-glyph-pressed:none;--xp-button-normal:linear-gradient(#fff,#d4d0c8);--xp-button-hover:linear-gradient(#fff,#d4d0c8);--xp-button-pressed:linear-gradient(#d4d0c8,#fff)}');
