...
function render(state = {}) {
  ...
  ['#self-avatar', '#screen-self-avatar'].forEach(selector => { $(selector).innerHTML = selfAvatar; }); ['#remote-avatar', '#screen-remote-avatar'].forEach(selector => { $(selector).innerHTML = remoteAvatar; });
